				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengShijian" id="kechengShijian" lay-verify="required" placeholder="上课时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengAddress" id="kechengAddress" lay-verify="required" placeholder="上课地点" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengNumber" id="kechengNumber"  lay-verify="required|integer"   placeholder="最大选课人数" autocomplete="off" class="layui-input">
							</div>
						</div>
