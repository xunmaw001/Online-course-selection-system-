					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengOrderUuidNumber" id="kechengOrderUuidNumber" lay-verify="required" placeholder="选课唯一编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengOrderNumber" id="kechengOrderNumber"  lay-verify="required|double"   placeholder="课程成绩" autocomplete="off" class="layui-input">
							</div>
						</div>
