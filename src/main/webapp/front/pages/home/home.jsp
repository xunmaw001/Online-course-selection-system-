            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="travel-gallery-wrapper">
                        <div class="row">
                            <div v-for="(item,index) in gonggaoList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 col-lg-3 single-box">
                                <div @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="part-img">
                                    ...
                                    <div class="part-txt">
                                        ...
                                        <div class="title">
                                            <h3>{{item.gonggaoName}}</h3>
                                            <p v-if="item.gonggaoNewMoney">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="travel-gallery-wrapper">
                        <div class="row">
                            <div v-for="(item,index) in kechengList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 col-lg-3 single-box">
                                <div @click="jumpCheck('../kecheng/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="part-img">
                                    ...
                                    <div class="part-txt">
                                        ...
                                        <div class="title">
                                            <h3>{{item.kechengName}}</h3>
                                            <p v-if="item.kechengNewMoney">
