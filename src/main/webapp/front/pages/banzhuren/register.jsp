            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">班主任姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="banzhurenName" id="banzhurenName"  placeholder="班主任姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">班主任手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="banzhurenPhone" id="banzhurenPhone"  lay-verify="phone|required"   placeholder="班主任手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="banzhurenEmail" id="banzhurenEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
