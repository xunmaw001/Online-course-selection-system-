    ...
    <ul id="category">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="banzhurenName" id="banzhurenName" lay-verify="required" placeholder="班主任姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="banzhurenPhone" id="banzhurenPhone"  lay-verify="required|phone"   placeholder="班主任手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="banzhurenPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="banzhurenPhoto" name="banzhurenPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="banzhurenEmail" id="banzhurenEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`banzhuren/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#banzhurenPhotoImg").attr("src", data.data.banzhurenPhoto);
                });
