                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="banzhurenName" id="banzhurenName" placeholder="班主任姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#banzhurenName').val() != null && jquery('#banzhurenName').val() != "" && jquery('#banzhurenName').val() != "null" ) {
                param['banzhurenName'] = jquery('#banzhurenName').val();
            }
                                        

            // 获取列表数据
            http.request('banzhuren/list', 'get', param, function(res) {
