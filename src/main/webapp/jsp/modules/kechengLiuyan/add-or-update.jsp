                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="xueshengId" name="xueshengId" type="hidden">
                                    <div class="form-group col-md-6 kechengLiuyanTextDiv">
                                        <label>留言内容</label>
                                        <textarea style="width: 450px"  id="kechengLiuyanText" name="kechengLiuyanText" class="form-control"placeholder="留言内容"></textarea>
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                kechengId: "required",
                xueshengId: "required",
                kechengLiuyanText: "required",
                replyText: "required",
            },
            messages: {
                kechengId: "课程不能为空",
                xueshengId: "学生不能为空",
                kechengLiuyanText: "留言内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#kechengLiuyanText").val(ruleForm.kechengLiuyanText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#kechengLiuyanText').attr('readonly', 'readonly');
