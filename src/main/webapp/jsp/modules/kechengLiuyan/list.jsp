...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //留言内容
            var kechengLiuyanTextCell = document.createElement('td');
            kechengLiuyanTextCell.innerHTML = item.kechengLiuyanText;
            row.appendChild(kechengLiuyanTextCell);
            ...
            if(
                window.sessionStorage.getItem('role') == "管理员"
                 || (window.sessionStorage.getItem('role') == "班主任" && window.sessionStorage.getItem('userId') == item.kechengBanzhurenId)
            ){
                //修改按钮
