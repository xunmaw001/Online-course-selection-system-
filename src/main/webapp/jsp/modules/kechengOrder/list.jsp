...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">课程选课管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">课程选课列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">课程选课列表</h3>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="kechengOrderUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="选课唯一编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //课程成绩
            var kechengOrderNumberCell = document.createElement('td');
            kechengOrderNumberCell.innerHTML = item.kechengOrderNumber;
            row.appendChild(kechengOrderNumberCell);
            ...
            debugger
            if(window.sessionStorage.getItem("role") == "班主任" && item.kechengOrderNumber == null){
                //修改按钮
