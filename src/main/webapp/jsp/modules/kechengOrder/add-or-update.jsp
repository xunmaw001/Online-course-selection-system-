    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑课程选课</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">课程选课管理</li>
                        <li class="breadcrumb-item active">编辑课程选课</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">课程选课信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="xueshengId" name="xueshengId" type="hidden">
                                    <div class="form-group col-md-6 kechengOrderNumberDiv">
                                        <label>课程成绩</label>
                                        <input style="width: 450px" id="kechengOrderNumber" name="kechengOrderNumber" class="form-control"
                                               onchange="kechengOrderNumberChickValue(this)" placeholder="课程成绩">
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function kechengOrderNumberChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                kechengId: "required",
                xueshengId: "required",
                kechengOrderNumber: "required",
            },
            messages: {
                kechengOrderUuidNumber: "选课唯一编号不能为空",
                kechengId: "课程不能为空",
                xueshengId: "学生不能为空",
                kechengOrderNumber: "课程成绩不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#kechengOrderNumber").val(ruleForm.kechengOrderNumber);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#kechengOrderUuidNumber').attr('readonly', 'readonly');
        }
        else{
            // alert("未知情况.......");
